...
class TodoList {
  ...
  static makeTodoList(rawTodoList) {
    ...
    /*
    The main thing to note with this code is that we need to add
    the Todo items to the new TodoList one at a time by using
    the add method. If we tried to use Object.assign instead, it
    would initialize the todos array with raw data,
    not an array of Todo objects.
    */
